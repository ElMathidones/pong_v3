...
window.addEventListener("keydown",(e)=>{ keys[e.key]=true;
  if(e.key==="Escape" && app.screen==="play"){
    // Browsers usually reserve ESC to leave fullscreen and do not allow blocking it.
    // So, when ESC is pressed in fullscreen, pause immediately instead of requiring a second ESC.
